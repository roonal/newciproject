				...
				<div class="item">
					<div class="col-md-3">
						<div class="thumb-wrapper">
							...
							<a href="<?php echo site_url('home/product_description') ?>"><img src="http://localhost:8081/ciproject/assets/images/dslr.jpg" class="img-responsive img-fluid"  alt="dslr_image"></a>
	...
	$(document).ready(function(){
		...
		<style>
		 	.home_image{
				...
				background-image: url("http://localhost:8081/ciproject/assets/images/191327.jpg");
			...
			.about_company{
				...
				background-image: url("http://localhost:8081/ciproject/assets/images/plain.jpg");
